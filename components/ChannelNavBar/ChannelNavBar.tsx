    ...
    <Header className={styles.sitePageHeader}>
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          {channel && !issue ? <Link href="/channel/postIssue/[channel]" as={`/channel/postIssue/${channel}`} passHref><Button type="primary">&emsp;&emsp; Post Issue &emsp;&emsp;</Button></Link>
